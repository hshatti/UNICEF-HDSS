...
?>        
    ...
    <body><div id="wait"><div class="loader"></div></div><div id="mainpage">
        <header><div id="sidenavshow" onclick="openNav()">&#9776; </div>
            <img class="hlogo" src="./img/UNICEF_logo_white.png"/><div class="page-title">Locations Status</div>
...
$q->Table= 'fwlocationstatus'; //sprintf(sqlBrowseActivities, $_SESSION['username'],$_SESSION['authflag']); 
$q->SQL='select l.ReportDate as "#gDate", a4.Location,a5.Description Neighbourhood,l.Admin4Id,l.Admin5Id,a.Description as "Access Status",Population,l.PiN from fwlocationstatus l join fwareastatus a on a.status=l.status join fwadmin4 a4 on a4.id=l.Admin4Id left outer join fwAdmin5 a5 on a5.Admin4Id=l.Admin4Id and a5.id=l.Admin5Id'
        . ' order by l.ReportDate';
//alert($q->SQL);
