...
?>        
    ...
    <body><div id="wait"><div class="loader"></div></div>  <div id="mainpage">
        <header><div id="sidenavshow" onclick="openNav()">&#9776; </div>
            <img class="hlogo" src="./img/UNICEF_logo_white.png"/><div class="page-title">Governorates</div>
...
$q->Table= 'fwgovernorates'; //sprintf(sqlBrowseActivities, $_SESSION['username'],$_SESSION['authflag']);  
//$q->SQL='select * from fwgovernorates';
$q->Open();
$r=new HithReport($q);
//$r=new Table($q);
