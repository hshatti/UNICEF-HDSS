...
?>        
    ...
    <body><div id="wait"><div class="loader"></div></div>  <div id="mainpage">
        <header><div id="sidenavshow" onclick="openNav()">&#9776; </div>
            <img class="hlogo" src="./img/UNICEF_logo_white.png"/><div class="page-title">Program</div>
...
$q->Table= 'fwprograms'; //sprintf(sqlBrowseActivities, $_SESSION['username'],$_SESSION['authflag']);  
$q->SQL='select p.YOB,p.ProgramId,s.Description Sector, p.Description,p.AltDesc from fwprograms p join fwsectors s on s.SectorId=p.SectorId where YOB='.$_SESSION['YOB'];
$q->Open();
$r=new HithReport($q);
//$r=new Table($q);
