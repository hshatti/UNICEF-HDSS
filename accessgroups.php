...
?>        
    ...
    <body><div id="wait"><div class="loader"></div></div><div id="mainpage">
        <header><div id="sidenavshow" onclick="openNav()">&#9776; </div>
            <img class="hlogo" src="./img/UNICEF_logo_white.png"/><div class="page-title">Access Groups</div>
...
$q->Table= 'fwusergroups';
$q->SQL=sprintf('select * from fwusergroups where ((AuthFlag<=%d)%s)',$_SESSION['authflag'],31==$_SESSION['authflag']?' or true':'');
$q->Open();
$r=new HithReport($q);
//$r=new Table($q);
