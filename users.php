...
?>        
    ...
    <body><div id="wait"><div class="loader"></div></div><div id="mainpage">
        <header><div id="sidenavshow" onclick="openNav()">&#9776; </div>
            <img class="hlogo" src="./img/UNICEF_logo_white.png"/><div class="page-title">Users</div>
...
$q->Table= 'fwusers';
$q->SQL=sprintf('select * from fwusers where ((flag<=%d and CountryId=%s)%s)',$_SESSION['authflag'], QuotedStr($_SESSION['CountryId']),31==$_SESSION['authflag']?' or true':'');
$q->Open();
$r=new HithReport($q);
//$r=new Table($q);
