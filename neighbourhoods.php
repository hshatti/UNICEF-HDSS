...
?>        
    ...
    <body>  
        ...
        <header><div id="sidenavshow" onclick="openNav()">&#9776; </div>
            <img class="hlogo" src="./img/UNICEF_logo_white.png"/><div class="page-title">Neighborhoods</div>
...
$q->Table= 'fwadmin5'; //sprintf(sqlBrowseActivities, $_SESSION['username'],$_SESSION['authflag']);  
$q->SQL=sprintf('select a4.Description "#gCity",a5.* from fwadmin5 a5 join fwadmin4 a4 on a4.Id=a5.Admin4Id');
$q->Open();
$r=new HithReport($q);
//$r=new Table($q);
