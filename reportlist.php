...
?>        
    ...
    <body><div id="wait"><div class="loader"></div></div><div id="mainpage">
        <header><div id="sidenavshow" onclick="openNav()">&#9776; </div>
            <img class="hlogo" src="./img/UNICEF_logo_white.png"/><div class="page-title">Reports</div>
...
$q->Table= 'genrep'; //sprintf(sqlBrowseActivities, $_SESSION['username'],$_SESSION['authflag']); 
//alert($q->SQL);
