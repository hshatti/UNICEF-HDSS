...
?>        
    ...
    <body><div id="wait"><div class="loader"></div></div><div id="mainpage">
        <header><div id="sidenavshow" onclick="openNav()">&#9776; </div>
            <img class="hlogo" src="./img/UNICEF_logo_white.png"/><div class="page-title">Partners</div>
...
$q->Table= 'fwpartners'; //sprintf(sqlBrowseActivities, $_SESSION['username'],$_SESSION['authflag']);  
$q->SQL=sprintf('select * from fwpartners p where exists (select * from fwusers u where u.CountryId=p.CountryId and u.username=%s)', QuotedStr($_SESSION['username']));
$q->Open();
$r=new HithReport($q);
//$r=new Table($q);
